<ref *1> Peer {
  core: Core {
    ...
    defaultAuth: { sign: [Function: sign], verify: [Function: verify] },
    truncating: 0,
    _maxOplogSize: 65536,
    _autoFlush: 1,
    _verifies: null,
  ...
  stream: <ref *2> NoiseSecretStream {
    ...
    rawStream: UDXStream {
      ...
      udx: [UDX],
      socket: [UDXSocket],
      _handle: <Buffer 08 7b cb 8b 18 80 77 5b 04 00 00 00 07 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 2e 0c 2e 00 00 00 00 00 00 00 00 00 ca 01 2d 01 00 00 00 00 cc ... 582 more bytes>,
      _view: [Uint32Array],
      _wreqs: [Array],
      _wfree: [],
      _sreqs: [],
      ...
      _closed: false,
      _mtuExceeded: false,
      _readBuffer: <Buffer 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ... 67160 more bytes>,
      _onwrite: null,
      _ondestroy: null,
    ...
    publicKey: <Buffer 18 c1 0a af 0c 23 e9 ee 5e 91 7f 7b c7 6c f4 0e d3 9d eb 23 5b 40 68 75 7f 4b 70 51 e8 5a b1 ed>,
    remotePublicKey: <Buffer 67 19 6a 0c cc 82 4d d7 f6 85 0d 11 da 67 ec 64 10 0e 60 6e 01 15 4f 08 4b d7 d1 e0 08 14 55 10>,
    ...
    _outgoingWrapped: <Buffer 02 00 81 41 08 02 00 00 03 00 00 00 01 00 00 00 a0 a5 93 3d 01 00 00>,
    _utp: null,
    _setup: false,
    _ended: 2,
    _encrypt: Push {
      key: <Buffer 76 2a cc 4e 25 ab 6e 29 b1 72 8d d5 9b d2 78 f6 8c be ae ca d1 21 62 bb d3 e8 98 3d 37 0c 83 f8>,
      state: <Buffer ec cb 0c 52 00 e8 cb eb 50 7e 20 16 d1 c9 3f 0b 08 36 38 bb 71 83 45 09 9c 04 a9 69 05 58 73 5c 05 00 00 00 67 b5 7e f8 16 bb a1 1b 00 00 00 00 00 00 ... 2 more bytes>,
      header: <Buffer 5b 74 e9 c6 0a 11 b1 21 dd 27 77 51 5f a7 2d a7 ba d7 45 a7 3b 37 8c ec>
    },
    _decrypt: Pull {
      key: <Buffer b8 64 4a 0e 37 04 12 c2 14 71 49 92 b3 70 7f a3 e7 56 59 d3 c1 bb 3e df c8 c2 6b 62 52 e0 07 bf>,
      state: <Buffer 9e 8d 52 9d 39 5a c8 99 4e 96 58 97 5c dd 16 7c 89 ac 7f 9b 4e 33 8b 6e 7d 6d cc c5 15 00 44 ed 04 00 00 00 19 e9 84 c7 89 73 0f be 00 00 00 00 00 00 ... 2 more bytes>,
      final: false
    },
    _timeout: null,
    _timeoutMs: 0,
  ...
  protomux: <ref *3> Protomux {
    ...
    _buffered: 0,
    _paused: false,
    _remote: [ [Object], [Object], [Object] ],
    _local: [ [Channel], [Channel], [Channel] ],
    _free: [],
  ...
  channel: Channel {
    ...
    handshake: {
      capability: <Buffer 3f c5 2b 7a 3d 91 06 54 7c c5 94 9f 29 8d 22 17 2e 25 79 c7 5b 9f f4 b0 85 96 fe 37 34 7f 71 41>
    },
    messages: [
      [Object], [Object],
      [Object], [Object],
